...
#define DEF_INI_NAME_PATH		"/system/etc/ilitek_9881h.ini"
#define DEF_FW_FILP_PATH		"/sdcard/ILITEK_FW"
#define DEF_INI_REQUEST_PATH		"ilitek_9881h.ini"
#define DEF_FW_REQUEST_PATH		"ILITEK_FW"
static unsigned char CTPM_FW_DEF[] = {
	//#include "CTD2001_9882N_BOE_6473_LongV_90Hz_V0x88.0x22.0x20.0x01_TEST.ili"
};
