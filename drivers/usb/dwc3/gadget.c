...
#if !defined(VIVO_PROJECT_MODEL)
static void dwc3_connect_detect_func(struct timer_list *t)
{
	struct dwc3 *dwc = from_timer(dwc, t, connect_detect_timer);
	unsigned long flags;
...
static void dwc3_ep0_detect_func(struct timer_list *t)
{
	struct dwc3 *dwc = from_timer(dwc, t, ep0_detect_timer);
	unsigned long flags;
...
#if !defined(VIVO_PROJECT_MODEL)
	timer_setup(&dwc->connect_detect_timer, dwc3_connect_detect_func, 0);
	timer_setup(&dwc->ep0_detect_timer, dwc3_ep0_detect_func, 0);
#endif
