...
/*
 * If the port has entered this state from the AttachWait.SRC state or
 ...
 * monitor its state.
 */
#ifdef VIVO_TYPC_FEATURE //merge form mtk
#define CONFIG_TYPEC_ATTACHED_SRC_SINGLE_RP
