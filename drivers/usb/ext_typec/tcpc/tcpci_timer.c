...
EXPORT_SYMBOL_GPL(tcpc_restart_timer);
...
EXPORT_SYMBOL_GPL(tcpc_enable_timer);
...
EXPORT_SYMBOL_GPL(tcpc_disable_timer);
...
EXPORT_SYMBOL_GPL(tcpc_reset_pe_timer);
...
int tcpci_timer_init(struct tcpc_device *tcpc_dev)
{
	...
	//wakeup_source_init(&tcpc_dev->wakeup_wake_lock, "wakeup_wake_lock");
	wakeup_source_add(&tcpc_dev->wakeup_wake_lock);
...
int tcpci_timer_deinit(struct tcpc_device *tcpc_dev)
{
	...
	wakeup_source_remove(&tcpc_dev->wakeup_wake_lock);
