...
EXPORT_SYMBOL_GPL(pd_alloc_msg);
...
EXPORT_SYMBOL_GPL(pd_put_event);
...
EXPORT_SYMBOL_GPL(pd_put_vdm_event);
...
EXPORT_SYMBOL_GPL(pd_put_last_vdm_event);
...
EXPORT_SYMBOL_GPL(pd_put_deferred_tcp_event);
...
EXPORT_SYMBOL_GPL(pd_notify_tcp_event_2nd_result);
...
EXPORT_SYMBOL_GPL(pd_event_buf_reset);
...
EXPORT_SYMBOL_GPL(pd_put_cc_attached_event);
...
EXPORT_SYMBOL_GPL(pd_put_cc_detached_event);
...
EXPORT_SYMBOL_GPL(pd_put_recv_hard_reset_event);
...
EXPORT_SYMBOL_GPL(pd_put_sent_hard_reset_event);
...
EXPORT_SYMBOL_GPL(pd_put_pd_msg_event);
...
EXPORT_SYMBOL_GPL(pd_put_vbus_changed_event);
...
EXPORT_SYMBOL_GPL(pd_put_vbus_safe0v_event);
...
EXPORT_SYMBOL_GPL(pd_put_vbus_stable_event);
...
EXPORT_SYMBOL_GPL(pd_put_vbus_present_event);
...
EXPORT_SYMBOL_GPL(tcpci_event_init);
...
EXPORT_SYMBOL_GPL(tcpci_event_deinit);
