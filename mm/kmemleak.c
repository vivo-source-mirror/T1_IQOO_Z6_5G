...
bool kmemleak_is_on(void)
{
	if (unlikely(kmemleak_enabled &&
...
void __init kmemleak_init(void)
{
	...
	if (!kmemleak_skip_disable) {
		pr_info("kmemleak disabled for kmemleak_skip_disable is false");
		kmemleak_disable();
		return;
	}
#endif
	...
	if (kmemleak_error) {
		pr_info("kmemleak disabled for kmemleak_error");
		return;
	}
