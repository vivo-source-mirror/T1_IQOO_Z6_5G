...
#define VOICE_TX_FLUENCE_PRO_VR_COPP_TOPOLOGY		0x1000001C
#define VOICE_TX_TM_FLUENCE_PRO_VC_COPP_TOPOLOGY	0x1000001D
#define VOICE_TX_TM_FLUENCE_EF_COPP_TOPOLOGY		0x1000001E
#define VPM_TX_FLUENCE_V5_TOPOLOGY				0x10028002
#define AUDIO_FLUENCE_V7_TOPO_COPP_TOPOLOGY			0x10028001
#define VOICE_TX_FLUENCE_BS_COPP_TOPOLOGY			0x10000007
#define VOICE_TX_FLUENCE_PRO_VC_COPP_TOPOLOGY		0x10000006
#define VOICE_TX_FLUENCE_SM_COPP_TOPOLOGY			0x10000004
#define VPM_TX_VOICE_FFEECNS_TOPOLOGY			0x10028003
#define VOICE_TX_FLUENCE_MM_SB_COPP_TOPOLOGY	0x10000020
#define VOICE_TX_FLUENCE_SM_SB_COPP_TOPOLOGY	0x10000021
#define AUDIO_RX_MONO_VOIP_MBDRC_V4     		0x11000101
#define VPM_TX_SM_FVSAM_COPP_TOPOLOGY			0x1000FFFB
#define VPM_TX_DM_FVSAM_COPP_TOPOLOGY			0x1000FFFC
#define VPM_TX_TM_FVSAM_COPP_TOPOLOGY			0x1000FFFD
#define VPM_RX_FVSAM_COPP_TOPOLOGY   			0x1000FFFE
#define AUDIO_TX_DM_FVSAM_COPP_TOPOLOGY   		0x1000FFFA
#define AUDIO_TX_SM_FVSAM_COPP_TOPOLOGY   		0x1000FFF9
#define VPM_TX_DADCS_FVSAM_COPP_TOPOLOGY		0x1000E006
#define VPM_TX_SM_LVVEFQ_COPP_TOPOLOGY			0x1000BFF0
#define VPM_TX_DM_LVVEFQ_COPP_TOPOLOGY			0x1000BFF1
#define VPM_TX_TM_LVVEFQ_COPP_TOPOLOGY			0x1000BFF3
#define VPM_RX_LVVEFQ_COPP_TOPOLOGY				0x1000BFF2
#define AUDIO_RX_MONO_VOIP_COPP_TOPOLOGY		0x11000101
#define VPM_TX_VOICE_FLUENCE_NN_COPP_TOPOLOGY	0x10028008
#define VPM_RX_DM_VIVO_VOIP_COPP_TOPOLOGY		0x100D2001
#define VPM_TX_DM_VIVO_VOIP_COPP_TOPOLOGY		0x100D2002
#define VIVO_RX_MG_VOICE_TOPOLOGY		0x10008889
#define VIVO_TX_MG_VOICE_TOPOLOGY		0x10008888
#define VPM_TX_SM_VIVO_VOIP_TOPOLOGY		0x100D2003
#define VPM_RX_SM_VIVO_VOIP_TOPOLOGY		0x100D2004
/* 6225 00, 6375 03, 6115 02*/
#define AW_COPP_TOPOLOGY		0x1000FF00
#define AW_COPP_TOPOLOGY_V2		0x1000FF02
#define AW_COPP_TOPOLOGY_V3		0x1000FF03
...
/* def VIVO_AUDIO_KTV */
#if 1
#define ADM_CMD_KTV_SET_PARAMS						0x0001052A
#define ADM_CMD_KTV_GET_PARAMS						0x0001052B
#define ADM_CMDRSP_KTV_GET_PARAMS					0x0001052C
#define ADM_CMD_KTV_OPEN							0x0001052E

enum {
	KTV_TYPE_INVALID = 0,
	KTV_TYPE_STATUS,
	KTV_TYPE_PARAMS,
	KTV_TYPE_MAX = KTV_TYPE_PARAMS,
};

struct adm_ktv_common_param {
	uint32_t param_size;
	uint32_t ktv_param_id;
} __packed;

struct adm_ktv_params {
	/* 1 means recording mixed data, 0 means recording dry data */
	uint32_t	mixed;
	/* music gain */
	int32_t		music_gain;
	/* mix rate */
	int32_t		mix_rate;
	/* Ears back switch */
	int32_t		vivo_ktv_ctl;
} __packed;

struct adm_cmd_set_ktv_params
{
	struct apr_hdr hdr;
	struct adm_ktv_params params;
} __packed;

struct adm_cmd_get_ktv_params
{
	struct apr_hdr hdr;
    uint32_t data_payload_addr_lsw;
    uint32_t data_payload_addr_msw;
...
struct adm_cmd_rsp_get_ktv_params
{
	uint32_t 	status;
}__packed;

struct adm_cmd_open_vivo_audio_ktv {
	struct apr_hdr			hdr;
	uint32_t                enable_flags;
	uint32_t                hp_rx_port_id;
	uint32_t                spk_rx_port_id;
} __packed;

/* definition of ktv tx topology */
#define AUDIO_TX_KTV_TOPOLOGY			0x10013001
/* definition of ktv module */
#define CAPI_V2_MODULE_KTV				0x10011001
/* definition of ktv params */
#define PARAM_ID_KTV_ENABLE				0x10012001
#define PARAM_ID_KTV_EQ_PARAMS			0x10012002
#define PARAM_ID_KTV_NOISECANCEL_PARAMS	0x10012003
#define PARAM_ID_KTV_COMPRESSOR_PARAMS	0x10012004
#define PARAM_ID_KTV_REVERB_PARAMS		0x10012005
#define PARAM_ID_KTV_ECHO_PARAMS		0x10012006
#define PARAM_ID_KTV_HC_PARAMS			0x10012007
#define PARAM_ID_KTV_GRAMOPHONE_PARAMS	0x10012008
#define PARAM_ID_KTV_VOICE_GAIN			0x10012009

struct ktv_func_enable {
	int32_t enable;
} __packed;
...
struct noise_cancel_params {
	int32_t enable;
} __packed;

struct gramophone_params {
	int32_t enable;
} __packed;
...
struct howling_cancel_params {
	int32_t enable;
} __packed;

struct reverb_params_vivo {
	int32_t enable;
	int32_t roomsize;
	int32_t damp;
	int32_t wet;
...
/* add for audio test start */
#define AFE_CMD_ADSP_RESTART_STRESS_TEST       0x00020000
...
struct afe_lpass_clk_config_acquire {
	struct apr_hdr hdr;
	struct afe_svc_cmd_set_param param;
	uint16_t port_id;
} __packed;

struct afe_lpass_clk_cfg_callback {
	uint32_t status;
	struct afe_clk_get cfg;
};

/* This cmd is used to get configuration of I2S clk */
#define AFE_SVC_CMD_GET_PARAM                  0x00020001
#define AFE_SVC_CMDRSP_GET_PARAM               0x00020002

/* This cmd is used to load dynamic modules */
#define ADM_CMD_ADSP_DYNAMIC_MOUDLE            0x00020003
/* add for audio test end **/
